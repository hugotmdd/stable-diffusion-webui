...
sd_model_file = os.path.join("/home/timour/storage/models/stable-diffusion/", 'sd-v1-4.ckpt')
...
parser.add_argument("--gfpgan-model", type=str, help="GFPGAN model file name", default='/home/timour/storage/models/gfpgan/GFPGANv1.4.pth')
